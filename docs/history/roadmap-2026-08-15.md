...
> **Historical roadmap.** The Go cutover completed on 2026-08-15. This file
> preserves the delivery plan and must not be used as current status. Use the
> [active issue register](../todo.md) and as-built ledgers in `docs/`.
