# Issue-register snapshot — 2026-08-17 production release

> **Frozen release snapshot.** This file preserves the complete issue register
> at the end of the 2026-08-17 production rollout, before closed work was split
> from the active backlog. Some entries were still open at capture time. Use
> the [current issue register](../todo.md) for present status and scheduling.
> Code and the [as-built ledgers](../README.md) remain the current behavior
> authority.
