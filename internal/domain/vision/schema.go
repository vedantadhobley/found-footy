...
// describes exactly the fields the schema requires. Both were validated on
// real prod clips in the 2026-07-28 bake-off (gemma-4-12b + Qwen3.5-9B):
// multi-frame single call, thinking off, 8/8 clips correct including a
// phone-of-TV rejection and a 90+2 stoppage clock.
package vision
  ...
  "properties": {
    "frames": {
      ...
      "items": {
        ...
        "required": ["soccer", "screen", "clock", "added", "stoppage_clock"],
...
// DefaultPrompt is the validated prompt. The screen definition (filming a
// TV vs a clean broadcast/fan-of-pitch) and the frozen-clock-plus-sub-timer
...
Read the scorebug carefully for all three time fields. Return exactly 3 frame objects, in order.`
