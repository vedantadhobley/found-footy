...
- [`docs/rebuild/proposals/`](./docs/rebuild/proposals/) — **design-first drafts for phases before they're committed.** Look here before proposing designs — all three current phase proposals SIGNED OFF 2026-07-16: `discovery.md` (O3/a unblocked), `twitter-port.md` (T/a unblocked after O3/a-c ship), `video-dedup.md` (V/a unblocked after T ships). `monitor.md` SUPERSEDED — historical only. `workflow-audit-2026-07-09.md` and `api-football-audit-2026-07-09.md` are cross-cutting audits, not phase proposals.
