...
- [`docs/rebuild/proposals/`](./docs/rebuild/proposals/) — **design-first drafts for phases before they're committed.** Look here before proposing designs — the next phase may already have an open proposal (currently: `discovery.md` for O3 with open questions awaiting review; `monitor.md` is SUPERSEDED — kept for historical context only). `workflow-audit-2026-07-09.md` and `api-football-audit-2026-07-09.md` are cross-cutting audits, not phase proposals.
